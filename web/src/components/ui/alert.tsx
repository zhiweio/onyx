...
const alertVariants = cva(
  "relative w-full rounded-lg border border-background-200 p-4 [&>svg~*]:ps-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:start-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-background-800 dark:[&>svg]:text-neutral-50",
  {
    variants: {
      variant: {
        broken:
