...
export function FileThumbnailLoadingOverlay() {
  return (
    <div
      aria-hidden="true"
      className="absolute inset-0 z-10 overflow-hidden bg-oklch(0.97 0 0) dark:bg-oklch(0.269 0 0)"
    >
      <div className="absolute inset-0 bg-oklch(0.97 0 0) dark:bg-oklch(0.269 0 0)" />
      <div className="absolute inset-0 animate-pulse bg-oklch(1 0 0)/55 motion-reduce:animate-none dark:bg-oklch(0.145 0 0)/55" />
    </div>
  );
}
export function FileThumbnail({
  ...
  return (
    <div
      className={cx(
        "group overflow-hidden rounded-lg border border-oklch(0.922 0 0) bg-oklch(1 0 0) text-oklch(0.145 0 0) dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.145 0 0) dark:text-oklch(0.985 0 0)",
        className
      )}
    >
      <div
        className={cx(
          "relative aspect-square overflow-hidden bg-oklch(0.97 0 0) [contain:layout_paint] dark:bg-oklch(0.269 0 0)",
          previewClassName
        )}
        style={
          previewAspectRatio
      ...
      >
        ...
        {showFallback ? (
          <div
            className="absolute inset-0 bg-oklch(0.97 0 0) dark:bg-oklch(0.269 0 0)"
            aria-hidden="true"
          />
        ) : null}
      </div>
