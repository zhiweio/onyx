...
license: Apache-2.0
compatibility: 'Claude Code ≥1.0, skills.sh marketplace, ClawHub marketplace, Vercel
  Labs skills ecosystem. No system packages required. Optional: MCP network access
  for SEO tool integrations.'
metadata:
  author: aaron-he-zhu
  version: 3.0.0
