...
_REGISTRY: Final = BuiltInSkillRegistry(
    providers=(
        ...
        SeededBuiltInProvider(skill_id="biomed-clinical-initiation"),
        SeededBuiltInProvider(
            skill_id="browser",
            is_available=lambda _: ENABLE_BROWSER,
            unavailable_reason="Browser runtime is not enabled for this deployment.",
        ),
        SeededBuiltInProvider(skill_id="hithink-finance"),
        SeededBuiltInProvider(skill_id="zhihuiya"),
        SeededBuiltInProvider(skill_id="qichacha"),
        SeededBuiltInProvider(skill_id="listed-co-entity-resolve"),
        SeededBuiltInProvider(skill_id="listed-co-filings-normalize"),
        SeededBuiltInProvider(skill_id="listed-co-metric-audit"),
        SeededBuiltInProvider(skill_id="listed-co-industry-context"),
        SeededBuiltInProvider(skill_id="listed-co-credit-legal"),
        ...
        SeededBuiltInProvider(skill_id="counterparty-risk-qcc"),
        SeededBuiltInProvider(skill_id="ubo-screening-qcc"),
        SeededBuiltInProvider(skill_id="trade-finance-compliance-qcc"),
        SeededBuiltInProvider(skill_id="credit-monitoring-qcc"),
        SeededBuiltInProvider(skill_id="equity-structure-qcc"),
        SeededBuiltInProvider(skill_id="executive-background-qcc"),
        SeededBuiltInProvider(skill_id="business-health-scan-qcc"),
        SeededBuiltInProvider(skill_id="guarantor-check-qcc"),
        SeededBuiltInProvider(skill_id="bankruptcy-monitor-qcc"),
        SeededBuiltInProvider(skill_id="ic-memo-qcc"),
        SeededBuiltInProvider(skill_id="history-evolution-qcc"),
        SeededBuiltInProvider(skill_id="strip-profile-qcc"),
        SeededBuiltInProvider(skill_id="competitor-analysis-qcc"),
        SeededBuiltInProvider(skill_id="fundraising-tracker-qcc"),
        SeededBuiltInProvider(skill_id="ip-asset-inventory-qcc"),
        SeededBuiltInProvider(skill_id="contract-review"),
        SeededBuiltInProvider(skill_id="contract-party-check-qcc"),
        SeededBuiltInProvider(skill_id="labor-compliance-qcc"),
        SeededBuiltInProvider(skill_id="ip-infringement-alert-qcc"),
        SeededBuiltInProvider(skill_id="debt-recovery-assessment-qcc"),
        SeededBuiltInProvider(skill_id="license-validation-qcc"),
