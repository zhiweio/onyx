...
_REGISTRY: Final = BuiltInSkillRegistry(
    providers=(
        ...
        SeededBuiltInProvider(skill_id="tax-recon-supplier"),
        SeededBuiltInProvider(skill_id="tax-bank-ledger"),
        SeededBuiltInProvider(skill_id="tax-expense-rollup"),
        ...
        SeededBuiltInProvider(skill_id="biomed-adc-dac-initiation"),
