...
class MCPServerResolver(CredentialResolver):
    ...
    def _resolve_for_server(
        ...
        with get_session_with_tenant(tenant_id=tenant_id) as db:
            ...
            # System servers carry a signed gateway token in the Authorization
            # header that build_headers() minted, which already names the
            # tenant. Nothing tenant-related is added here.
